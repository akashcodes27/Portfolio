...
//     <section
//       id="hero"
//       className="min-h-screen pt-24 px-8 bg-gradient-to-br from-frostyWhite to-white text-mapleGray flex flex-col md:flex-row items-center justify-between gap-10 w-full"
//     >
//       {/* Left Side: Text */}
//       <motion.div
...
//       >
//         <h1 className="text-5xl md:text-6xl font-extrabold text-canadaRed drop-shadow-md">
//           Hey, I’m Akash 🇨🇦
//         </h1>
...
//           <button className="bg-canadaRed text-white px-6 py-3 rounded-full font-medium shadow-lg hover:shadow-xl transition hover:scale-105">
//             View Projects
//           </button>
//           <button className="border border-canadaRed text-canadaRed px-6 py-3 rounded-full font-medium hover:bg-canadaRed hover:text-white transition hover:scale-105">
//             Contact Me
//           </button>
//         </div>
//       </motion.div>
